...
let cadd_test2 _test_ctxt =
  (* TODO *)
  assert_equal (CI(3,3)) (cadd (CI(1,2)) (CI(2,1)));;
...
let cmult_test2 _test_ctxt =
  (* TODO *)
  assert_equal (CI(-5,10)) (cmult (CI(1,2)) (CI(3,4)));;

(* write another unit test for cmult *)
let cmult_test3 _test_ctxt =
  (* TODO *)
  assert_equal (CI(5,10)) (cmult (CI(2,1)) (CI(4,3)));;

(* write another unit test for cmult *)
let cmult_test4 _test_ctxt =
  (* TODO *)
  assert_equal (CI(-13,82)) (cmult (CI(5,6)) (CI(7,8)));; 
(* list of unit tests *)
let unit_tests =
